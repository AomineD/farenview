package com.dagf.persoview.flipviewpager.adapter;
...
import com.dagf.persoview.flipviewpager.view.FlipViewPager;
    ...
    public void onBindViewHolder(BaseViewHolder baseViewHolder, final int position) {
        ...
        baseViewHolder.mFlipViewPager.setOnChangePageListener(new FlipViewPager.OnChangePageListener() {
            ...
            public void onFlipped(int page) {
             //   Log.e("MAIN", "onFlipped: pos = "+page);
                settings.savePageState(position, page);
            }
        });

        flipViewPagerMap.put(position, baseViewHolder.mFlipViewPager);
      //  Log.e("MAIN", "onBindViewHolder: "+position+" item2 = "+(item2!=null)+" itemsize = "+items.size());
        baseViewHolder.mFlipViewPager.setAdapter(new MergeAdapter(item1, item2, position), settings.getDefaultPage(), position, 2);
    }
